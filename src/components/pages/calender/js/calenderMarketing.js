    ...
    let calendarSwitch2 = (function() {
        ...
        function calendarSwitch2(element, options) {
            this.settings = $.extend(true, $.fn.calendarSwitch2.defaults, options || {});
            this.element = element;
            this.init();
        }
        calendarSwitch2.prototype = { /*说明：初始化插件*/
            ...
            init: function() {
                ...
                var minDate = me.settings.minDate;
            
                // var maxDate =me.settings.maxDate;
                ...
                var html = "<div class='headerWrapper'><div class='headerTip'></div><div class='comfire'></div></div><table class='dateZone'><tr><td class='colo'>日</td><td>一</td><td>二</td><td>三</td><td>四</td><td>五</td><td class='colo'>六</td></tr></table>" + "<div class='tbody'></div>"
                $(me.sections).append(html);
                for (var q = 0; q < me.index; q++) {
                    var select = q;
                    $(me.sections).find(".tbody").append("<p class='ny1'></p><table class='dateTable'></table>");
                  
                    var obj=minDate.Format("yyyy-MM-dd");
                    var currentDate = new Date(obj);
                     // minDate=new Date('2020-11-11 12:00:00');
            ...
            _initselected: function() {
                ...
                var minDate = me.settings.minDate;
                var strDays = new Date(minDate).getDate();
        ...
        return calendarSwitch2;
    })();
    $.fn.calendarSwitch2 = function(options) {
        return this.each(function() {
            var me = $(this),
                instance = me.data("calendarSwitch2");
 
            if (!instance) {
                me.data("calendarSwitch2", (instance = new calendarSwitch2(me, options)));
            }
 
            if ($.type(options) === "string") return instance[options]();
        });
    };
    $.fn.calendarSwitch2.defaults = {
        selectors: {
            sections: "#calendar"
        },
        index: 4,
...
module.exports = calendarSwitch2
